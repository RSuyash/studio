    ...
    subtopics: [
      {
        ...
        subtopics: [
          ...
          },
          {
            ...
            resources: [],
            subtopics: [
                { id: 'prelims-geography-physical', title: 'Physical Geography', description: 'Geomorphology (landforms, volcanoes), Climatology, and Oceanography.', tags: [], mastery: 'none', resources: [] },
                { id: 'prelims-geography-indian', title: 'Indian Geography', description: 'Physiography, river systems, climate, soils, vegetation, agriculture, and mineral resources.', tags: [], mastery: 'none', resources: [] },
                { id: 'prelims-geography-world', title: 'World Geography (Basics)', description: 'Continents, Oceans, and major global physical features.', tags: [], mastery: 'none', resources: [] },
            ]
          },
          {
      ...
      },
      {
        ...
        subtopics: [
            ...
            { id: 'prelims-csat-reasoning', title: 'Logical Reasoning & Analytical Ability', description: 'Syllogisms, blood relations, puzzles, seating arrangements.', tags: [], mastery: 'none', resources: [] },
            ...
            { id: 'prelims-csat-di', title: 'Data Interpretation', description: 'Interpreting charts, graphs, and tables (Class X level).', tags: [], mastery: 'none', resources: [] },
            { id: 'prelims-csat-decision-making', title: 'Decision Making & Problem Solving', description: 'Questions on ethical dilemmas and practical problem-solving. No negative marking for these.', tags: [], mastery: 'none', resources: [] },
        ]
      },
    ],
  },
  {
    ...
    subtopics: [
      ...
      },
      {
        ...
        resources: [],
        subtopics: [
          { id: 'mains-essay-structure', title: 'Structure & Evaluation', description: 'Two sections, with one essay choice from each (125 marks each). Evaluated on relevance, organization, clarity, analytical depth, and concise expression.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-essay-strategy', title: 'Strategy & Topics', description: 'Topics are broad, often philosophical or interdisciplinary. Practice structuring arguments with contemporary relevance and historical/philosophical depth.', tags: [], mastery: 'none', resources: [] },
        ],
      },
      {
        id: 'mains-gs1',
        ...
        resources: [],
        subtopics: [
          { id: 'mains-gs1-art-culture', title: 'Indian Art & Culture', description: 'Salient aspects of art forms, architecture, literature from ancient to modern times.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs1-modern-history', title: 'Modern Indian History', description: 'Mid-18th century to present: key events, personalities, issues. Freedom struggle and Post-independence consolidation & state reorganization.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs1-world-history', title: 'World History', description: 'Events from the 18th century onwards: Industrial Revolution, world wars, decolonization, nation-state formation, and key ideologies.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs1-society', title: 'Indian Society', description: 'Social structure: diversity, secularism, challenges. Women’s role, population dynamics, poverty, urbanization, and globalization.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs1-geography', title: 'Geography – India & World', description: 'Physical geography (earth structure, climate, hazards). Human geography (industry locations, resources). Environmental issues (climate change, ecological challenges).', tags: [], mastery: 'none', resources: [] },
        ],
      },
      {
        id: 'mains-gs2',
        ...
        subtopics: [
          ...
          { id: 'mains-gs2-welfare', title: 'Welfare Schemes and Policies', description: 'Policies for vulnerable sections (SC/ST, women, children), performance of schemes, and the role of NGOs/SHGs.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs2-justice', title: 'Social Justice', description: 'Issues related to poverty, hunger, health, education, and inclusive growth.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs2-ir', title: 'International Relations', description: 'India’s neighborhood relations, bilateral/global groupings, effect of foreign policies, and the role of the Indian diaspora and international institutions.', tags: [], mastery: 'none', resources: [] },
        ]
      },
      {
        id: 'mains-gs3',
        ...
        resources: [],
        subtopics: [
          { id: 'mains-gs3-economy', title: 'Indian Economy', description: 'Planning, resource mobilization, growth, budgeting, agriculture (MSP, PDS, e-tech), land reforms, infrastructure, and investment models.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs3-scitech', title: 'Science & Technology', description: 'Developments, applications, achievements of Indians, awareness in new fields (space, AI, biotech), and indigenization of technology.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs3-environment', title: 'Environment and Ecology', description: 'Conservation, pollution, EIA, climate change agreements (UNFCCC, Paris), biodiversity, and sustainable development.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs3-dm', title: 'Disaster Management', description: 'Types of disasters, disaster preparedness, mitigation strategies, and NDMA guidelines.', tags: [], mastery: 'none', resources: [] },
          { id: 'mains-gs3-security', title: 'Internal Security', description: 'Linkages with extremism, role of external/non-state actors, cybersecurity, money laundering, and mandates of security forces.', tags: [], mastery: 'none', resources: [] },
        ]
      },
      {
        id: 'mains-gs4',
        ...
        resources: [],
        subtopics: [
            { id: 'mains-gs4-ethics-interface', title: 'Ethics and Human Interface', description: 'Essence, determinants, and consequences of Ethics in human actions; dimensions of ethics; ethics in private and public relationships. Human Values from leaders, reformers and administrators.', tags: [], mastery: 'none', resources: []},
            ...
            { id: 'mains-gs4-aptitude', title: 'Aptitude & Foundational Values', description: 'Integrity, impartiality, non-partisanship, objectivity, dedication to public service, empathy, tolerance, and compassion. Emotional intelligence (EI) concepts and their utility.', tags: [], mastery: 'none', resources: []},
            { id: 'mains-gs4-thinkers', title: 'Moral Thinkers & Philosophers', description: 'Contributions from Indian and World thinkers like Gandhi, Kant, Aristotle, etc.', tags: [], mastery: 'none', resources: []},
            { id: 'mains-gs4-public-service', title: 'Public/Civil Service Values', description: 'Ethical concerns and dilemmas in government and private institutions; laws, rules, and conscience as sources of guidance; accountability and ethical governance.', tags: [], mastery: 'none', resources: []},
            { id: 'mains-gs4-probity', title: 'Probity in Governance', description: 'Concept of public service; philosophical basis of governance and probity; RTI, codes of ethics/conduct; work culture, and challenges of corruption.', tags: [], mastery: 'none', resources: []},
            { id: 'mains-gs4-casestudies', title: 'Case Studies', description: 'Analysis of realistic or hypothetical scenarios to test ethical decision-making.', tags: [], mastery: 'none', resources: []},
        ]
      },
      {
        id: 'mains-optional',
          ...
          },
          {
            ...
            subtopics: [
              ...
              },
              {
                ...
                resources: [],
                subtopics: [
                  { id: 'psych-p1-motivation', title: 'Motivation', description: 'Theories: Drive, Incentive, Maslow’s Hierarchy, Herzberg, McClelland, Self-determination. Intrinsic vs. extrinsic. Achievement motivation. Conflicts.', tags: [], mastery: 'none', resources: []},
                  { id: 'psych-p1-emotion', title: 'Emotion', description: 'Theories: James-Lange, Cannon-Bard, Schachter-Singer, Lazarus. Physiological correlates. Facial feedback hypothesis. Emotional intelligence. Stress and coping.', tags: [], mastery: 'none', resources: []},
                ]
              },
              {
          ...
          },
          {
            ...
            subtopics: [
                ...
                },
                {
                    ...
                    resources: [],
                    subtopics: [
                        { id: 'psych-p2-legal', title: 'a. Legal System', description: 'Psychology of evidence, eyewitness testimony, criminal behavior, juvenile delinquency, forensic and police psychology.', tags: [], mastery: 'none', resources: []},
                        { id: 'psych-p2-media', title: 'b. Media', description: 'Effects of TV, cinema, social media. Advertising, consumer behavior. Fake news, digital addiction, cyberpsychology.', tags: [], mastery: 'none', resources: []},
                        { id: 'psych-p2-military', title: 'c. Military Psychology', description: 'Mental toughness, personnel selection, motivation, combat stress/PTSD, psychological warfare, leadership.', tags: [], mastery: 'none', resources: []},
                    ]
                },
                {
