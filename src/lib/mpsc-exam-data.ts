      ...
      subStages: [
        {
          ...
          syllabus: [
            ...
            'Physical Geography: Himalayas, rivers, climate, soils',
            ...
            'Indian Constitution: features, amendments, Preamble',
            'Fundamental Rights and Duties, DPSPs',
            'Union and State governments',
            'Parliament and State Legislature',
            'Judiciary system',
            'Election Commission, CAG, UPSC, MPSC',
            'Local governance: 73rd & 74th Amendments, Panchayati Raj',
            'RTI Act, Disaster Management Act',
            'Social justice: SC/ST/OBC/Minority issues',
            ...
            'Climate change: causes, effects, global conventions',
            ...
            'Important figures in Maharashtra history',
          ]
        },
        {
            title: 'Syllabus – Prelims Paper II – CSAT (Aptitude Test)',
            description: '',
            syllabus: [
